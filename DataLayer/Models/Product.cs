...
namespace DataLayer.Models
{
    public class Product
    {
        ...
        [DisplayName("پیشنهاد شگفت انگیز است ؟")]
        [Display(Name = "پیشنهاد شگفت انگیز است ؟")]
        public bool IsWonderful { get; set; }

        [DisplayName("روز مانده")]
        [Display(Name = "روز مانده")]
        public int? Day { get; set; }

        [DisplayName("ساعت مانده")]
        [Display(Name = "ساعت مانده")]
        public int? Hour { get; set; }

        [DisplayName("دقیقه مانده")]
        [Display(Name = "دقیقه مانده")]
        public int? Minute { get; set; }

        [DisplayName("تاریخ پیشنهاد شگفت انگیز")]
        [Display(Name = "تاریخ پیشنهاد شگفت انگیز")]
        public DateTime? WonderDate { get; set; }

        [DisplayName("تاریخ شگفت انگیز")]
        [Display(Name = "تاریخ شگفت انگیز")]
