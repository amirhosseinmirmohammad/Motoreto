...
namespace GladcherryShopping.Areas.Administrator.Controllers
{
    ...
    public class CategoriesController : Controller
    {
        ...
        public ActionResult Create([Bind(Include = "Id,PersianName,EnglishName,Icon,SmallImage,LargeImage,BackgroundProImage,ParentId")] Category category,
        ...
        [HttpPost]
        [ValidateAntiForgeryToken]
        public ActionResult Edit([Bind(Include = "Id,PersianName,EnglishName,Icon,SmallImage,LargeImage,BackgroundProImage,ParentId")] Category category,
            HttpPostedFileBase small_image, HttpPostedFileBase large_image, HttpPostedFileBase background_image)
        {
            if (ModelState.IsValid)
            {
